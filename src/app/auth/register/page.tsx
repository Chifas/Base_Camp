...
export default function RegisterPage() {
  ...
  return (
    <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-[1400px] grid-cols-1 gap-4 p-4 sm:p-6 lg:grid-cols-12 lg:gap-6 lg:p-8">
      ...
      <AuthAside
        eyebrow="Comunidad 150+"
        title={
          <>
            Empieza tu{" "}
            <span className="text-gradient-on-dark">camino</span> hoy
          </>
        }
        subtitle="Crea tu cuenta gratis. 3 sesiones al mes por videollamada con profesionales verificados, sin tarjeta, sin compromiso."
      />
        ...
        <div className="w-full max-w-md rounded-3xl border bg-card/70 p-7 shadow-xl backdrop-blur-xl sm:p-10">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              3 sesiones al mes gratis, sin tarjeta ni compromiso.
            </p>
          </div>

          <div className="mt-8 space-y-6">
            {/* Role selector — bento pill group */}
            <div className="grid grid-cols-2 gap-2 rounded-2xl border bg-background/50 p-1">
              <button
                type="button"
