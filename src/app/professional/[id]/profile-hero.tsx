...
export function ProfileHero({
  ...
  const coverColor = getCoverColor(name);
    ...
    <div ref={heroRef}>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="-mt-[60px] relative flex flex-col items-center sm:flex-row sm:items-end sm:gap-6">
          ...
          <div ref={photoRef} className="shrink-0">
            <div className="relative h-[120px] w-[120px] overflow-hidden rounded-2xl bg-stone-100 ring-4 ring-white dark:bg-stone-800 dark:ring-stone-900">
              {image ? (
                ...
                <div
                  className={`flex h-full w-full items-center justify-center ${coverColor} text-2xl font-bold text-stone-700`}
                >
                  {initials}
                </div>
              )}
          ...
          {/* Name + sub-info */}
          <div className="mt-4 min-w-0 flex-1 text-center sm:mt-0 sm:pb-2 sm:text-left">
            <div
              ref={nameRef}
              className="flex flex-col items-center gap-2 sm:flex-row sm:items-center"
            >
              <h1 className="font-display text-2xl font-extrabold tracking-tight text-stone-900 dark:text-stone-50 sm:text-3xl">
                {name}
              </h1>
              {verified && (
                <CheckCircle2
        ...
        <div
          ref={pillsRef}
          className="mt-5 flex flex-wrap justify-center gap-3 pb-2 sm:justify-start"
        >
